...
<a href="https://github.com/nikhilcharan-dev">
  <img src="https://64.media.tumblr.com/eb8e76984014d0db1e53ec7795f03ec0/1924a8282a163135-34/s540x810/1884baa6bdd0cfc5bfd175dad4131c9f438cc0de.gif" alt="Banner" width="80%" border-radius="30%" />
</a>

<br />

<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=28&duration=2800&pause=800&color=7C3AED&center=true&vCenter=true&width=720&lines=Hey%2C+I'm+Nikhil+%F0%9F%91%8B;Full+Stack+Developer;Blockchain+Engineer+in+the+making;Self-Hosting+on+the+Cloud;Arise.+Level+up.+Repeat." alt="Typing header" />
</a>

<br />

> *"The strongest version of me is just the one I refuse to stop building."*
> — **Sung Jin-Woo**
...
const nikhil = {
  ...
  learning:     ["Blockchain / Web3", "System Design", "DevOps"],
  weapons:      ["C++", "JavaScript", "Solidity"],
  stack:        ["React", "Next.js", "React Native", "Node.js"],
  infra:        ["Linux", "Oracle Cloud", "PM2"],
  currentQuest: "Self-hosting and shipping full-stack apps",
  philosophy:   "Consistency > Motivation",
};
```

- 🔭 Currently building with **React**, **Next.js**, and **React Native**
- ☁️ Self-hosting projects on **Oracle Cloud** Ubuntu VMs, kept alive with **PM2**
- 🌱 Going deeper into **Blockchain** and **decentralized networks**
- 🧠 Competitive programmer at heart — I live in C++ and logic puzzles
- 🤝 Open to **open-source collabs** and **hackathon teams**
...
![Remix IDE](https://img.shields.io/badge/Remix_IDE-1C1B1B?style=for-the-badge&logo=ethereum&logoColor=white)
...
### *"Sharpen in silence — the world only hears the strike."*
